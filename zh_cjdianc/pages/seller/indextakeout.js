...
Page({
    ...
    Coupons: function() {
        ...
        app.util.request({
            ...
            success: function(t) {
                console.log(t.data);
                for (var a = [], e = [], o = 0; o < t.data.length; o++) "2" != t.data[o].type && "0" != t.data[o].stock && a.push(t.data[o]), 
                "2" == t.data[o].state && "2" != t.data[o].type && "0" != t.data[o].stock && e.push(t.data[o]);
                s.setData({
                    Coupons: a,
                    wlqyhq: e,
                    hbtoggle: 0 < e.length
    ...
    spxqck: function(t) {
        ...
        var a = t.currentTarget.dataset.itemIndex, e = t.currentTarget.dataset.parentindex, o = (this.data.dishes, 
        this.data.cart_list.res, t.currentTarget.dataset.goodid, this.data.dishes[e].good[a]);
...
        });
    ...
    cartdec: function(t) {
        for (var a = t.currentTarget.dataset.itemIndex, e = t.currentTarget.dataset.parentindex, o = this.data.dishes, s = this.data.cart_list.res, i = t.currentTarget.dataset.goodid, n = this, r = this.data.dishes[e].good[a], d = (wx.getStorageSync("users").id, 
        this.data.store_id, 0); d < s.length; d++) if (s[d].good_id == i) {
            var c = 1;
            Number(r.start_num) == Number(s[d].num) && (c = Number(r.start_num));
            var l = Number(s[d].num) - c, g = s[d].id;
    ...
    cartadd: function(t) {
        var a = t.currentTarget.dataset.itemIndex, e = t.currentTarget.dataset.parentindex, o = this.data.dishes, s = this.data.cart_list.res, i = t.currentTarget.dataset.goodid, n = this, r = this.data.dishes[e].good[a], d = wx.getStorageSync("users").id, c = this.data.store_id, l = "1" == getApp().xtxx.hygn && this.data.iszk && "0.00" != r.vip_money ? 1 : 0, g = 1;
        "0" == r.start_num || n.isInArray(s, i) || (g = Number(r.start_num)), console.log(g), 
        wx.showLoading({
            title: "正在加载",
            mask: !0
        }), app.util.request({
    ...
    ggaddcart: function() {
        ...
        var o = this.data.dishes, s = this, i = this.data.gginfo, t = wx.getStorageSync("users").id, a = this.data.gg, e = this.data.store_id, n = [], r = !0;
        for (var d in a) {
            var c = !1;
    ...
    scrolltolower: function() {
        var s = this.data.dishes, i = this, e = wx.getStorageSync("users").id, o = i.data.store_id, n = this.data.loadindex;
    ...
    selectMenu: function(t) {
        this.data.dishes;
        var a = this, e = (wx.getStorageSync("users").id, a.data.store_id, t.currentTarget.dataset.itemIndex);
        this.setData({
...
        });
    ...
    onLoad: function(t) {
        ...
        var l = this, c = l.data.store_id, g = util.formatTime(new Date()).slice(11, 16), goodid = t.goodid;
        app.util.request({
            ...
            success: function(t) {
                ...
                1 == i ? (l.setData({
                    yysjtoggle: !1
                }), console.log("商家正在休息" + i)) : console.log("商家正在营业" + i), a < s ? a < g && g < e || o < g && g < s || o < g && s < o ? (console.log("商家正常营业"), 
                l.setData({
                    time: 1
            ...
            var d = wx.getStorageSync("users").id, c = l.data.store_id;
        ...
        }),l.getGoodInfo(goodid);
    },
    maketel: function(t) {
        var a = this, e = this.data.store.tel, o = this.data.paytel;
