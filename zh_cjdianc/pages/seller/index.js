...
Page({
    ...
    commentPicView: function(t) {
        console.log(t);
        var a = this.data.storelist, e = [], s = t.currentTarget.dataset.index, o = t.currentTarget.dataset.picindex, n = t.currentTarget.dataset.id;
    ...
    jumps: function(t) {
        var a = t.currentTarget.dataset.id, e = t.currentTarget.dataset.name, s = t.currentTarget.dataset.appid, o = t.currentTarget.dataset.src, n = t.currentTarget.dataset.wb_src, i = t.currentTarget.dataset.type;
    ...
    refresh: function(t) {
        var l = this, c = util.formatTime(new Date()).slice(11, 16);
        app.util.request({
            ...
            success: function(t) {
                ...
                var e = t.data.storeset, s = l.data.nav;
                "1" == e.is_dn && (s[1].active = !0, "" != e.dn_img && (s[1].img = e.dn_img), "" != e.dn_name && (s[1].name = e.dn_name), 
                "" != e.dnsm && (s[1].smwz = e.dnsm)), "1" == e.is_wm && (s[0].active = !0, "" != e.wm_img && (s[0].img = e.wm_img), 
                "" != e.wm_name && (s[0].name = e.wm_name), "" != e.wmsm && (s[0].smwz = e.wmsm)), 
                "1" == e.is_yy && (s[2].active = !0, "" != e.yy_img && (s[2].img = e.yy_img), "" != e.yy_name && (s[2].name = e.yy_name), 
                "" != e.sysm && (s[2].smwz = e.yysm)), "1" == e.is_sy && (s[3].active = !0, "" != e.sy_img && (s[3].img = e.sy_img), 
                "" != e.sy_name && (s[3].name = e.sy_name), "" != e.sysm && (s[3].smwz = e.sysm)), 
                "1" == e.is_qg && "1" == getApp().xtxx.qggn && (s[4].active = !0, "" != e.qg_img && (s[4].img = e.qg_img), 
                "" != e.qg_name && (s[4].name = e.qg_name), "" != e.qgsm && (s[4].smwz = e.qgsm)), 
                "1" == e.is_pt && "1" == getApp().xtxx.ptgn && (s[5].active = !0, "" != e.pt_img && (s[5].img = e.pt_img), 
                "" != e.pt_name && (s[5].name = e.pt_name), "" != e.ptsm && (s[5].smwz = e.ptsm)), 
                "1" == e.is_pd && (s[6].active = !0, "" != e.pd_img && (s[6].img = e.pd_img), "" != e.pd_name && (s[6].name = e.pd_name), 
                "" != e.pdsm && (s[6].smwz = e.pdsm)), console.log(s), l.setData({
                    nav: s
                });
                var o = t.data.store.time, n = t.data.store.time2, i = t.data.store.time3, r = t.data.store.time4, d = t.data.store.is_rest;
                console.log("当前的系统时间为" + c), console.log("商家的营业时间从" + o + "至" + n, i + "至" + r), 
                1 != d ? (console.log("商家正在营业" + d), o < r ? o < c && c < n || i < c && c < r || i < c && r < i ? (console.log("商家正常营业"), 
                l.setData({
                    time: 1
                    ...
                    time: 3
                })) : r < o && (o < c && c < n || i < c && r < c || c < i && c < r ? (console.log("商家正常营业"), 
                l.setData({
                    time: 1
                })) : c < o || n < c && c < i ? (console.log("商家还没开店呐，稍等一会儿可以吗？"), l.setData({
                    time: 2
    ...
    maketel: function(t) {
        var a = this, e = this.data.store_info.tel, s = this.data.paytel;
